...
public class CarMain {
    public static void main(String[] args) {
        ...
        Car c4 = new Car("aa", "VARIANT", Double.valueOf(100d), 2009, Arrays.asList(m1,m2), Engine.V8);
        Car c5 = new Car("ba", "VARIANT", Double.valueOf(100d), 2005, Arrays.asList(m1,m2), Engine.V8);
        Car c6 = new Car("ga", "VARIANT", Double.valueOf(100d), 2002, Arrays.asList(m1,m2), Engine.V8);
        Car c7 = new Car("ca", "VARIANT", Double.valueOf(100d), 2000, Arrays.asList(m1,m2), Engine.V8);
        ...
        Comparator<Car> comparator = SortType.ASC.getComparator(Car::getName);
